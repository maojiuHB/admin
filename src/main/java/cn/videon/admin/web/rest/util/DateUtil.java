package cn.videon.admin.web.rest.util;
...
public class DateUtil {
    ...
    public static List<Instant> getNowFullTime(Instant instant) {
        Date stime = Date.from(instant);
        stime.setHours(0);
        stime.setSeconds(0);
        stime.setMinutes(0);
        Instant startTme = Instant.ofEpochMilli(stime.getTime());
        stime.setDate(stime.getDate() + 1);
        Instant endTime = Instant.ofEpochMilli(stime.getTime());
